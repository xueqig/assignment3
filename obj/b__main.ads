...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#e5a712af#;
   ...
   u00106 : constant Version_32 := 16#e6d4fa36#;
   pragma Export (C, u00106, "ada__stringsS");
   u00107 : constant Version_32 := 16#8ba6725a#;
   pragma Export (C, u00107, "mycommandlineB");
   u00108 : constant Version_32 := 16#dbf720e9#;
   pragma Export (C, u00108, "mycommandlineS");
   u00109 : constant Version_32 := 16#01a73f89#;
   pragma Export (C, u00109, "ada__command_lineB");
   u00110 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00110, "ada__command_lineS");
   u00111 : constant Version_32 := 16#e1642826#;
   pragma Export (C, u00111, "mystringB");
   u00112 : constant Version_32 := 16#ce083c8f#;
   pragma Export (C, u00112, "mystringS");
   u00113 : constant Version_32 := 16#72d5fbb0#;
   pragma Export (C, u00113, "mystringtokeniserB");
   u00114 : constant Version_32 := 16#fd8d8b9c#;
   pragma Export (C, u00114, "mystringtokeniserS");
   u00115 : constant Version_32 := 16#5b4659fa#;
   pragma Export (C, u00115, "ada__charactersS");
   u00116 : constant Version_32 := 16#4b7bb96a#;
   pragma Export (C, u00116, "ada__characters__latin_1S");
   u00117 : constant Version_32 := 16#df0de0ff#;
   pragma Export (C, u00117, "operationB");
   u00118 : constant Version_32 := 16#94ab6225#;
   pragma Export (C, u00118, "operationS");
   u00119 : constant Version_32 := 16#956aef3d#;
   pragma Export (C, u00119, "stackB");
   u00120 : constant Version_32 := 16#8a700eda#;
   pragma Export (C, u00120, "stackS");
   u00121 : constant Version_32 := 16#f3a38af4#;
   pragma Export (C, u00121, "stringtointegerB");
   u00122 : constant Version_32 := 16#37c4f5b6#;
   pragma Export (C, u00122, "stringtointegerS");
   u00123 : constant Version_32 := 16#868dcd5d#;
   pragma Export (C, u00123, "variablestoreB");
   u00124 : constant Version_32 := 16#da769ae4#;
   pragma Export (C, u00124, "variablestoreS");
   u00125 : constant Version_32 := 16#179d7d28#;
   pragma Export (C, u00125, "ada__containersS");
   u00126 : constant Version_32 := 16#8225628b#;
   pragma Export (C, u00126, "ada__containers__red_black_treesS");
   u00127 : constant Version_32 := 16#bcec81df#;
   pragma Export (C, u00127, "ada__containers__helpersB");
   u00128 : constant Version_32 := 16#4adfc5eb#;
   pragma Export (C, u00128, "ada__containers__helpersS");
   u00129 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00129, "system__atomic_countersB");
   u00130 : constant Version_32 := 16#bc074276#;
   ...
   u00134 : constant Version_32 := 16#53a75631#;
   ...
   u00143 : constant Version_32 := 16#039168f8#;
   ...
   u00145 : constant Version_32 := 16#adae3cb6#;
   pragma Export (C, u00145, "passwordmanagerB");
   u00146 : constant Version_32 := 16#246897bd#;
   pragma Export (C, u00146, "passwordmanagerS");
   u00147 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00147, "ada__characters__handlingB");
   u00148 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00148, "ada__characters__handlingS");
   ...
   u00154 : constant Version_32 := 16#0c5e1d96#;
   pragma Export (C, u00154, "pinB");
   u00155 : constant Version_32 := 16#553c8633#;
   pragma Export (C, u00155, "pinS");
   u00156 : constant Version_32 := 16#dde34de3#;
   pragma Export (C, u00156, "system__exp_intB");
   u00157 : constant Version_32 := 16#11785907#;
   pragma Export (C, u00157, "system__exp_intS");
   u00158 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00158, "system__memoryB");
   u00159 : constant Version_32 := 16#512609cf#;
